...
class CaseService:
    ...
    async def run_stage(self, case_id: str, stage: str) -> Dict[str, Any]:
        """
        ...
        """
        logger.info("Running single stage", case_id=case_id, stage=stage)
        ...
        if stage == "policy_analysis":
            return await self._run_policy_analysis_stage(case_state)
    ...
    async def _run_policy_analysis_stage(self, case_state) -> Dict[str, Any]:
